...
// Get Posts Count
export function gethPostsCount() {
    return async (dispatch) => {
      try {
...
export function toggleLikePost(postId) {
  return async (dispatch,getState) => { // getState => Only Logged in user can toggle like post so we need to send Token to Server
    try {
...
export function updatePostImage(newImage,postId) {
  return async (dispatch,getState) => { // getState => Onlu Logged in user can toggle like post so we need to send Token to Server
    try {
